...
@Component({
  selector: 'lib-avatar-badge-with-mask',
  templateUrl: './avatar-badge-with-mask.component.html',
  styleUrl: 'avatar-badge-with-mask.component.scss',
  host: {
...
export class AvatarBadgeWithMaskComponent extends BaseComponent {
